        ...
        <Box sx={styles.contentWrapper}>
          ...
          <Box as="form" sx={styles.subscribe} onSubmit={handleSubmit}>
            <Flex sx={styles.inputGroup}>
              ...
              <Input id="email" type="email" className="email-input" placeholder="Enter Email address" />
              <Button variant="secondary">Subscribe</Button>
            </Flex>
            <Box sx={styles.checkbox}>
              <Label htmlFor="no_spam" className={checked ? "checked" : ""}>
                <Checkbox id="no_spam" onChange={handleCheckbox} defaultChecked={checked} />
...
const styles = {
  section: {
    background: ["none", null, null, `#F8F0EA url(${illustration}) no-repeat center bottom / contain`],
